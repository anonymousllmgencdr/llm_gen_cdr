...
class DataArguments:
    ...
    stage1_bs: Optional[int] = field(
        default=None,
        metadata={"help": "阶段1全局batch_size"},
    )
    ...
    max_inter: Optional[int] = field(
        default=None,
        metadata={"help": "序列阶段长度"},
    )
    title_embedding_path: Optional[str] = field(
        default=None,
        metadata={"help": "title压缩后的embedding路径"},
    )
